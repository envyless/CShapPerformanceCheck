...
public class AntSpawner : MonoBehaviour, IConvertGameObjectToEntity
{
    // Add fields to your component here. Remember that:
    //
    // * The purpose of this class is to store data for authoring purposes
    // - it is not for use while the game is
    //   running.
    // 
    // * Traditional Unity serialization rules apply:
    // fields must be public or marked with [SerializeField], and
